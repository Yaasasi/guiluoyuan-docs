...
<Callout emoji="⚡️">
  您可参照 TeamSpeak5 客户端使用指南，以设置 TeamSpeak6 客户端，各各配置项并无太大变化。\
...
| Linux | V6.0.0-beta27 | [官方源](https://files.teamspeak-services.com/pre_releases/client/6.0.0-beta2/teamspeak-client.tar.gz) |
