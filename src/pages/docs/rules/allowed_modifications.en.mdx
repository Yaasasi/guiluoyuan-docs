---
title: Losenone Community Minecraft Allowed Modifications
---

# Losenone Community Minecraft Allowed Modifications


### Preface

For many players, Minecraft mods are an important part of the gaming experience. Their functions range from small performance and visual enhancements to major changes in gameplay. While Minecraft mods offer such powerful features and additional content, not all mods are allowed to be used on the servers open in the Losenone Community. This regulation clearly specifies and emphasizes which types of mods are allowed to be used on the Losenone Community's open servers and which types are not allowed.


### Important Notes

Please be aware that once you use Minecraft mods on the Losenone Community's open servers, you will bear the risks associated with using Minecraft mods. Make sure you have carefully read, fully understood, and unreservedly accepted this regulation before using Minecraft mods on the Losenone Community's open servers.\
This regulation cannot cover all Minecraft mods, and it cannot guarantee that any mod complies with Losenone Community rules. If a Minecraft mod does not belong to any of the types listed below, it is assumed to not be allowed for use on the Losenone Community's open servers.\
All Minecraft mods you install should be obtained from official sources provided by the mod, such as the developer's personal website, GitHub, CurseForge, and Modrinth. Mods obtained from unofficial sources may not work as described by the mod's official information, may contain bugs or undisclosed features &#40;which could result in penalties on the Losenone Community's open servers&#41;, and may even contain malicious content &#40;such as viruses, spyware, etc.&#41;.\
If we find that a community member is using mod types explicitly prohibited by this regulation, that community member will be permanently banned from the Losenone Community and its associated servers. All permissions within the Losenone Community will be revoked, and the member's information will be recorded in the Losenone Community's internal blacklist.\
